...
export default function RegisterForm({ onStepChange }: RegisterFormProps) {
  ...
  return (
    ...
    >
      ...
      <motion.button
        type="submit"
        disabled={loading || !formData.name || !validations.emailValid || !validations.phoneValid}
        variants={itemVariants}
        whileHover={{ scale: 1.02, y: -2 }}
        whileTap={{ scale: 0.98 }}
        className="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-bold uppercase tracking-wider hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none"
      >
